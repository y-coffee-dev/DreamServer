#!/usr/bin/env python3
# ============================================================================
# AUTO-MIRRORED from dream-server/scripts/dream-cluster-supervisor.py
# DO NOT EDIT THIS FILE DIRECTLY — edits will be overwritten at image build.
# The canonical source is scripts/dream-cluster-supervisor.py (fully tested
# in tests/test-cluster-supervisor.py). installers/phases/08-images.sh
# copies the canonical file here right before `docker build`, so this copy
# exists only to satisfy Docker's requirement that COPY sources live inside
# the build context.
# ============================================================================
"""
